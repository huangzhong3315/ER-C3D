...
from lib.model.rpn.twin_transform import clip_twins
from lib.model.nms.nms_wrapper import nms
from lib.model.rpn.twin_transform import twin_transform_inv
...
from lib.model.tdcnn.resnet import resnet34, resnet50, resnet_tdcnn
...
def parse_args():
    ...
    parser.add_argument('--dataset', dest='dataset',default='thumos14', type=str,
                      help='test dataset')
    parser.add_argument('--net', dest='net',default='c3d', type=str, choices=['c3d', 'c3d', 'res34', 'res50', 'eco'],
    ...
    parser.add_argument('--checkpoint', default=11678, type=int,
