...
class _TDCNN(nn.Module):
    ...
    def __init__(self):
        ...
        # define rpn
        # self.RCNN_rpn = _RPN(self.dout_base_model, self.frame)  # self.dout_base_model = 512
    ...
    def forward(self, video_data, gt_twins):
        ...
        # if cfg.USE_ATTENTION:
        #     pooled_feat1 = self.RCNN_attention(base_feat)
        ...
        # rois, _, _, rpn_loss_cls, rpn_loss_twin, _, _ = self.RCNN_rpn(pooled_feat1, gt_twins)
